...
状态（2026-09-16 17:14 北京时间）：新候选已在 aigc29 GPU0–3 启动，训练日志确认推进至至少 111/1000 optimizer steps；尚无完整 checkpoint、离线终检或新成功率。运行目录为 `/mnt/100T/users/dingxin/VLA/zeva-runs/robotwin-v5-h15-tasklang/gradient-route-full-20260916-a29/gradient_route_full`，独立源码快照为 `/mnt/100T/users/dingxin/VLA/gradient-route-test-20260916-PZL6Hh`。训练进程仍需后续核验；不能把启动或预检当作 1000 步完成。
